...
export default function AttackGenealogyTree() {
 ...
 <span className="p-2 bg-aegis-red/20 border border-aegis-red/50">Gen 1: Fuzzing Amount (Blocked)</span>
 </div>
 <GitCommit className="w-4 h-4 mx-auto text-aegis-border" />
 <div className="flex items-center justify-center gap-2">
 <span className="p-2 bg-aegis-red/20 border border-aegis-red/50">Gen 2: Fuzzing Amount + Time (Blocked)</span>
 </div>
 <GitMerge className="w-4 h-4 mx-auto text-aegis-border" />
 <div className="flex items-center justify-center gap-4">
 <span className="p-2 bg-aegis-green/20 border border-aegis-green/50">Gen 3: Amount + 3am Burst (Bypass)</span>
 </div>
