...
export default function AdversarialInstanceView({ liveData }: { liveData?: any }) {
 ...
 return (
 <div className="bg-white border border-slate-200 shadow-sm flex flex-col overflow-hidden h-full">
 ...
 <span className={`ml-auto text-[9px] font-bold px-2 py-0.5 border ${phaseColors[liveData.battle_phase] || phaseColors.IDLE}`}>
 ...
 <span className={`text-[8px] font-bold px-1.5 py-0.5 border ${phaseColors[inst.phase ||"IDLE"] || phaseColors.IDLE}`}>
 {inst.phase ||"—"}
 </span>
 </td>
