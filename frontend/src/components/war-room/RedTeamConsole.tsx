...
export default function RedTeamConsole({
 ...
 return (
 <div className="bg-white border border-slate-200 shadow-sm h-full flex flex-col min-h-0 overflow-hidden relative">
 {/* Header */}
 ...
 <span className="ml-auto text-xs font-medium text-slate-500 bg-white px-2 py-1 border border-slate-200">
 ...
 className="appearance-none bg-slate-50 border border-slate-200 text-slate-700 text-xs font-medium pl-3 pr-8 py-1.5 focus:outline-none focus:ring-2 focus:ring-slate-400 cursor-pointer"
 >
 ...
 className={`w-full text-left p-3 border transition-all group bg-white shadow-sm relative
 ${
 launching === atk.id
 ...
 <span
 className={`flex items-center gap-1.5 text-[10px] font-medium px-2 py-0.5 border ${
 ...
 {atk.risk ==="critical" && (
 <span className="text-[10px] font-bold text-red-600 flex items-center gap-1 bg-red-50 px-2 py-0.5 border border-red-100">
 <AlertTriangle className="w-3 h-3" /> CRITICAL
 </span>
 )}
 {atk.bypass_rate !== undefined && atk.bypass_rate > 0 && (
 <span className="text-[10px] font-mono text-amber-600 ml-auto bg-amber-50 px-2 py-0.5 border border-amber-100">
