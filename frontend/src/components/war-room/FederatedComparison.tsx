...
export default function FederatedComparison({ data }: { data: FederatedData | null }) {
 ...
 {d.round && (
 <span className="ml-auto text-[10px] font-mono text-slate-500 bg-slate-50 px-2 py-1 border border-slate-200">
 ROUND {d.round}
 </span>
 )}
 </div>
 ...
 className="h-full bg-vanguard-blue rounded-full"
 />
 </div>
 ...
 <Globe className="w-4 h-4 text-vanguard-green" /> Global Model Aggregation
 </span>
 </div>
 <div className="flex items-center gap-3">
 <div className="flex-1 h-5 bg-vanguard-green-light/30 rounded-full overflow-hidden relative border border-vanguard-green/20 shadow-inner">
 <motion.div
 initial={{ width: 0 }}
 animate={{ width: `${d.federated.f1 * 100}%` }}
 transition={{ duration: 1.5, delay: 0.8 }}
 className="h-full bg-vanguard-green rounded-full shadow-[0_0_10px_rgba(2,122,72,0.4)]"
 />
 </div>
 <span className="text-base font-mono font-bold text-vanguard-green w-14 text-right">
 ...
 className="flex items-center justify-center gap-2 mt-4 py-2 px-3 bg-vanguard-green-light/30 border border-vanguard-green/20 shadow-sm"
 >
 <ArrowUp className="w-4 h-4 text-vanguard-green" />
 <span className="text-xs font-semibold text-vanguard-green uppercase tracking-wide">
